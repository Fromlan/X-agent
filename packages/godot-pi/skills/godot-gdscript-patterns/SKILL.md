...
description: Master Godot 4 GDScript patterns: signals, scenes, state machines, optimization. Use when building Godot games, implementing systems, or applying GDScript best practices.
---
