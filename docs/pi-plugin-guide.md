...
主流 Agent（Cursor / Claude Code / Codex / Windsurf）的 **Plan Mode** 与 **Goal Mode** 对照、Pi Extension / X-agent 钩子映射，以及半硬 `/plan`+`/build` MVP 规格，参考根目录 [`context.md`](../context.md) 与 [`CLAUDE.md`](../CLAUDE.md) 中「会话模式」相关章节。
