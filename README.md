...
基于 [Pi](https://pi.dev) SDK 的 Electron 桌面 Agent 客户端。面向通用编程助手，并对 Godot 编辑器提供 RPC 控制面。
...
**Agent 上下文**：模型实际看到的 system / 技能 / 工具 / 会话如何组织，见 [`AGENT_CONTEXT.md`](AGENT_CONTEXT.md)。
