/**
 * Orbits mode (the "working" state) — ported from thinking-orbs
 * (https://github.com/Jakubantalik/thinking-orbs), MIT © Jakub Antalik.
 * Particles run on tilted orbits with no nucleus: ghost paths + the
 * particles doing the work. Depth is carried by dot size and ink alone.
 */
